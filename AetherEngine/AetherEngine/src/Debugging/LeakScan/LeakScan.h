...
namespace Aeth::Debugging::LeakScan
{
	/// <summary>
	...
	/// </summary>
	extern size_t totalAllocatedMemorySize;
...
extern void* operator new(size_t size, const char* file, uint32_t line);

extern void* operator new[](size_t size, const char* file, uint32_t line);

extern void operator delete(void* p, const char* file, uint32_t line);
